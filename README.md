...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/enneaum/EIPs?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge)

Ennea Improvement Proposals (EIPs) describe standards for the Ennea platform, including core protocol specifications, client APIs, and contract standards.

A browsable version of all current and draft EIPs can be found on [the official EIP site](https://github.com/enneam/eips).
...
# Contributing
 ...
 4. Submit a Pull Request to Ennea's [EIPs repository](https://github.com/ethereum/EIPs).
